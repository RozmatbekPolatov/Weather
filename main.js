...
btn.addEventListener("click", async () => {
  ...
  try {
    ...
    const tavsif = data.weather[0].description; // Agar tavsifni ham HTML ichida chiqarmoqchi bo'lsangiz

    // 2. HTML tarkibini yangilash
    natija.innerHTML = `
      <div class="temp">
        ...
        <div class= "sundata">
          ...
          <h4 class="tempre">°</h4>
          <span class="weather-desc">${tavsif}</span>
          </div>
        </div>
      </div>
      <p>Namlik: ${namlik}%</p>
